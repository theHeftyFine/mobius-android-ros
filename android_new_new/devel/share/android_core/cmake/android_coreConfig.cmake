...
if("TRUE" STREQUAL "TRUE")
  set(android_core_SOURCE_PREFIX /home/student/android_new/src/android_core)
  set(android_core_DEVEL_PREFIX /home/student/android_new/devel)
  ...
  set(android_core_INSTALL_PREFIX /home/student/android_new/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'android_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/android_new/src/android_core/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>, Damon Kohler <damonkohler@google.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/android_new/devel/lib;/opt/ros/hydro/lib)
